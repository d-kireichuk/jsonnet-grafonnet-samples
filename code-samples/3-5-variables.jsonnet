...
local instance_mapping = [
   {var_name:'load_controller',aws_ec2_name_tag:'ec2-d-load-controller-plab',ami:true},
   {var_name:'load_generator_1',aws_ec2_name_tag:'ec2-d-load-generator-1-plab',ami:true},
   {var_name:'load_generator_2',aws_ec2_name_tag:'ec2-d-load-generator-2-plab',ami:false},
   {var_name:'load_generator_3',aws_ec2_name_tag:'ec2-d-load-generator-3-plab',ami:false},
   {var_name:'load_generator_4',aws_ec2_name_tag:'ec2-d-load-generator-4-plab',ami:false},
   {var_name:'load_generator_5',aws_ec2_name_tag:'ec2-d-load-generator-5-plab',ami:false}
];
...
//Resulting array which is imported to dashboard.jsonnet
{
  ...
  [var_ec2_ami.attributes(var_name=instance.var_name,aws_ec2_name_tag=instance.aws_ec2_name_tag) for instance in instance_mapping if instance.ami]
}